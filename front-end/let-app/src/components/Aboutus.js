...
export default function Aboutus() {
  const aboutUs = [
    "Leelavathi Educational Trust started out in the year 2018 with a philanthropic vision of spreading educational awareness and helping students make academic and career decision that fits them the best.",
    "With 18 + years in service and a strong presence in the states of Andhra Pradesh and Tamil Nadu, Leelavathi Educational Trust has successfully extended educational and career guidance to more than 5000 students and their families.",
