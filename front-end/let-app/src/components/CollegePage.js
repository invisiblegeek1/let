        ...
        <div className="College-data-container">
          <div className="College-data-list-container">
            ...
            <div  className="data-list-item-header">
                  ...
                  <div className="item_college">Name and Address of medical college</div>
                  <div className="item_seats">Annual intake seats</div>
                  </div>
              {data.map((item,index)=>{
                return <div key={index} className="data-list-item">
                  
                  <div className="item_no">{item.SNo}</div>
                  <div className="item_course">{item.courese_name}</div>
                  <div className="item_management">{item.management_of_college}</div>
                  <div className="item_college">{item.name_and_address_of_medical_college}</div>
